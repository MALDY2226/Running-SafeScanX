...
const serviceAccount = JSON.parse(fs.readFileSync('./test1-2458b-firebase-adminsdk-93gec-295357ac6d.json', 'utf8'));
admin.initializeApp({
    credential: admin.credential.cert(serviceAccount),
    databaseURL: "https://malware-2226.firebaseio.com",
    storageBucket: "gs://test1-2458b.appspot.com"  // Use your actual storage bucket
});
